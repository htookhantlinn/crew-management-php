...
!function (t, e) {
  ...
  const t = {
    ...
    l = e => a(e) ? e.jquery ? e[0] : e : "string" == typeof e && e.length > 0 ? t.findOne(e) : null, c = (t, e) => {
      let i = !1;
      const n = e + 5;
    ...
    name: "arrow", enabled: !0, phase: "main", fn: function (t) {
      ...
      if (o && r) {
        var d = function (t, e) {
          ...
          g = Tt(o), _ = g ? "y" === l ? g.clientHeight || 0 : g.clientWidth || 0 : 0, b = p / 2 - m / 2, v = d[u],
  ...
  function Yt(t, e) {
    ...
    var i = e, n = i.placement, s = void 0 === n ? t.placement : n, o = i.boundary,
      ...
      p = void 0 === f ? 0 : f, m = xt("number" != typeof p ? p : Dt(p, st)),
  ...
  function Qt(t, e) {
    ...
    var i = e, n = i.placement, s = i.boundary, o = i.rootBoundary, r = i.padding, a = i.flipVariations,
      l = i.allowedAutoPlacements, c = void 0 === l ? rt : l, d = Kt(n), h = d ? a ? ot : ot.filter((function (t) {
        return Kt(t) === d
    ...
    name: "flip", enabled: !0, phase: "main", fn: function (t) {
      ...
      if (!e.modifiersData[n]._skip) {
        for (var s = i.mainAxis, o = void 0 === s || s, r = i.altAxis, a = void 0 === r || r, l = i.fallbackPlacements, c = i.padding, d = i.boundary, h = i.rootBoundary, u = i.altBoundary, f = i.flipVariations, p = void 0 === f || f, m = i.allowedAutoPlacements, g = e.options.placement, _ = pt(g), b = l || (_ !== g && p ? function (t) {
          ...
          var O = v[L], k = pt(O), C = "start" === Kt(O), x = [tt, et].indexOf(k) >= 0, D = x ? "width" : "height",
  ...
  var te = {
    ...
    name: "preventOverflow", enabled: !0, phase: "main", fn: function (t) {
      var e = t.state, i = t.options, n = t.name, s = i.mainAxis, o = void 0 === s || s, r = i.altAxis,
        ...
        g = Yt(e, {boundary: l, rootBoundary: c, padding: h, altBoundary: d}), _ = pt(e.placement), b = Kt(e.placement),
        v = !b, y = At(_), w = "x" === y ? "y" : "x", E = e.modifiersData.popperOffsets, T = e.rects.reference,
        A = e.rects.popper, L = "function" == typeof m ? m(Object.assign({}, e.rects, {placement: e.placement})) : m,
        O = {x: 0, y: 0};
      if (E) {
        if (o || a) {
          var k = "y" === y ? tt : nt, C = "y" === y ? et : it, x = "y" === y ? "height" : "width", D = E[y],
            N = E[y] + g[k], S = E[y] - g[C], I = f ? -A[x] / 2 : 0, j = "start" === b ? T[x] : A[x],
            P = "start" === b ? -A[x] : -T[x], M = e.elements.arrow, H = f && M ? gt(M) : {width: 0, height: 0},
