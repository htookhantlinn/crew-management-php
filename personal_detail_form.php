    ...
    <div class="container-fluid mt-5">
        <div class="row">
            <div class="col-md-4">
                ...
                <input type="text" required  class="form-control" id="person_name" name="person_name"
            ...
            <div class="col-md-4">
                ...
                <input type="text" required  class="form-control" id="sur_name" name="sur_name" placeholder="Enter Surname">
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
                <label class="form-label">Father Name*:</label>
                <input type="text" required  class="form-control" id="father_name" name="father_name"
                    placeholder="Enter Father Name">
            </div>
            <div class="col-md-4">
                <label class="form-label">Mother Name*:</label>
                <input type="text" required  class="form-control" id="mother_name" name="mother_name"
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <input type="text" required  class="form-control" id="rank" name="rank" placeholder="Enter Rank">
            </div>
            <div class="col-md-4">
                <label class="form-label">Applied vessel type *:</label>
                <input type="text" required  class="form-control" id="applied_velssel_type" name="applied_velssel_type"
                    placeholder="Enter Applied Vessel Type">
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="text" required  class="form-control" id="final_school" name="final_school"
                    placeholder="Enter Final School">
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
                <label class="form-label">Martial Status:</label>
                <input type="text" required  class="form-control" id="martial_status" name="martial_status"
                    placeholder="Enter Martial Status">
            </div>
            <div class="col-md-4">
                <label class="form-label">Telephone 1*:</label>
                <input type="text" required  class="form-control" id="telephone_one" name="telephone_one"
                    placeholder="Enter Telephone one">
            </div>
            <div class="col-md-4">
                <label class="form-label">Telephone 2*:</label>
                <input type="text" required  class="form-control" id="telephone_two" name="telephone_two"
                    placeholder="Enter Telephone two">
            </div>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <input type="text" required  class="form-control" id="english_capability" name="english_capability"
                    placeholder="Enter English Capability">
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="text" required  class="form-control" id="net_of_kin" name="net_of_kin"
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <input type="text" required  class="form-control" id="passport_number" name="passport_number"
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <input type="text" required  class="form-control" id="sbook_number" name="sbook_number"
                    placeholder="Enter  sbook No ">
            </div>
            <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <input type="text" required  class="form-control" id="license" name="license" placeholder="Enter License  ">
            </div>
            <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <input type="text" required  class="form-control" id="licensed_number" name="licensed_number"
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <input type="text" required  class="form-control" id="nok_relationship" name="nok_relationship"
                    placeholder="Enter Nok Relationship  ">
            </div>
            <div class="col-md-6">
                <label class="form-label">Health Inspection:</label>
                <input type="text" required  class="form-control" id="health_inspection" name="health_inspection"
                    placeholder="Enter Health Inspection">
            </div>
            <div class="col-md-2">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <input type="text" required  class="form-control" id="bank_info" name="bank_info" placeholder="Enter Bank Info  ">
            </div>
