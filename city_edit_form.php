...
<div class=" container  d-flex justify-content-center align-items-center " style="height: 400px;">
    <form method="post">
        <div class=" m-3 ">
            <input class=" form-control " type="text" value="<?php echo $result['name'] ?>" name="city_name_update" id="city_name_update" placeholder="Enter City name " required autofocus />
        </div>
